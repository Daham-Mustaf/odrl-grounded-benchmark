"""
gen_runtime_problems.py
=======================
Generates the Theorem 3 runtime audit problems from
...
from problem_data_runtime import PROBLEMS
from writers import (
    write_fof_problem,
    write_smt2_problem,
    write_ttl_policy,
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate the Theorem 3 runtime audit problems."
    )
    ...
    print(f"\nGenerated {len(written)} Theorem 3 problems:")
