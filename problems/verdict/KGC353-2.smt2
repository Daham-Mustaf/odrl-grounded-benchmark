...
(assert (! (not (or (and (kge_leq lb_dpv_legal_basis lb_dpv_legal_basis) (= lb_dpv_legal_basis lb_gdpr_a6_1_a_explicit_consent)) (and (kge_leq lb_gdpr_a6_1_a_explicit_consent lb_dpv_legal_basis) (= lb_gdpr_a6_1_a_explicit_consent lb_gdpr_a6_1_a_explicit_consent)))) :named w_kgc353))
(check-sat)
(get-unsat-core)
(get-model)
(exit)
