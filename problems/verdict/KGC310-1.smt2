...
; Problem  : purpose, isA dpv:R&D against eq dpv:SR (witness condition asserted)
; Version  : 1.0
...
(assert (or (and (kge_leq dpv_research_and_development dpv_research_and_development) (= dpv_research_and_development dpv_scientific_research))
    (and (kge_leq dpv_scientific_research  dpv_research_and_development) (= dpv_scientific_research  dpv_scientific_research))))
(check-sat)
(exit)
