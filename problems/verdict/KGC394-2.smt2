...
; Problem  : purpose, isAnyOf {RnD, Marketing} against eq ScientificResearch, declared distinct (witness condition negated)
; Version  : 1.0
...
; side names it.
(assert (! (not (= dpv_scientific_research dpv_research_and_development)) :named bg_dist_dpv_scientific_research_dpv_research_and_development))
(assert (! (not (= dpv_scientific_research dpv_marketing)) :named bg_dist_dpv_scientific_research_dpv_marketing))
; witness condition negated
(assert (! (not (and (or (= dpv_research_and_development dpv_scientific_research) (= dpv_marketing dpv_scientific_research) (= dpv_scientific_research dpv_scientific_research)) (or (and (= dpv_research_and_development dpv_scientific_research) (or (= dpv_research_and_development dpv_research_and_development) (= dpv_research_and_development dpv_marketing))) (and (= dpv_marketing dpv_scientific_research) (or (= dpv_marketing dpv_research_and_development) (= dpv_marketing dpv_marketing))) (and (= dpv_scientific_research dpv_scientific_research) (or (= dpv_scientific_research dpv_research_and_development) (= dpv_scientific_research dpv_marketing)))))) :named w_kgc394))
(check-sat)
(get-unsat-core)
(get-model)
(exit)
