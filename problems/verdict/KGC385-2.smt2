...
; Problem  : spatial, eq loc:DE-NW against eq loc:DE-BY, ISO rule (witness condition negated)
; Version  : 1.0
...
(assert (! (not (or (and (= loc_de_nw loc_de_nw) (= loc_de_nw loc_de_by)) (and (= loc_de_by loc_de_nw) (= loc_de_by loc_de_by)))) :named w_kgc385))
(check-sat)
(get-unsat-core)
(get-model)
(exit)
