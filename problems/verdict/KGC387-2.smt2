...
(assert (! (not (or (and (and (not (= loc_de_by loc_de_by)) (not (= loc_de_by loc_de_be))) (= loc_de_by loc_de_hh)) (and (and (not (= loc_de_be loc_de_by)) (not (= loc_de_be loc_de_be))) (= loc_de_be loc_de_hh)) (and (and (not (= loc_de_hh loc_de_by)) (not (= loc_de_hh loc_de_be))) (= loc_de_hh loc_de_hh)))) :named w_kgc387))
(check-sat)
(get-unsat-core)
(get-model)
(exit)
