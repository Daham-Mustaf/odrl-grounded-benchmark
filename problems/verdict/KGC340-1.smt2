...
; Problem  : consent status, isA ValidForProcessing against eq ConsentGiven (witness condition asserted)
; Version  : 1.0
...
(assert (! (or (and (kge_leq dpv_consent_status_valid_for_processing dpv_consent_status_valid_for_processing) (= dpv_consent_status_valid_for_processing dpv_consent_given)) (and (kge_leq dpv_consent_given dpv_consent_status_valid_for_processing) (= dpv_consent_given dpv_consent_given))) :named w_kgc340))
(check-sat)
(get-unsat-core)
(get-model)
(exit)
