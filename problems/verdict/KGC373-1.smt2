...
(assert (! (kge_concept bcp_en) :named res_bcp47_en))
(assert (! (not (= bcp_de bcp_en)) :named bg_dist_bcp47_de_en))
; witness condition asserted
(assert (! (or (and (= bcp_de bcp_de) (= bcp_de bcp_en)) (and (= bcp_en bcp_de) (= bcp_en bcp_en))) :named w_kgc373))
(check-sat)
(get-unsat-core)
(get-model)
(exit)
