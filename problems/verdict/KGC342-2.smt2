...
(assert (! (not (or (and (kge_leq dpv_consent_status_valid_for_processing dpv_consent_status_valid_for_processing) (= dpv_consent_status_valid_for_processing dpv_consent_withdrawn)) (and (kge_leq dpv_consent_withdrawn dpv_consent_status_valid_for_processing) (= dpv_consent_withdrawn dpv_consent_withdrawn)))) :named w_kgc342))
(check-sat)
(get-unsat-core)
(get-model)
(exit)
