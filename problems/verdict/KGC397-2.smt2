...
(assert (! (not (or (and (not (= dpv_marketing dpv_marketing)) (= dpv_marketing dpv_advertising)) (and (not (= dpv_advertising dpv_marketing)) (= dpv_advertising dpv_advertising)))) :named w_kgc397))
(check-sat)
(get-unsat-core)
(get-model)
(exit)
