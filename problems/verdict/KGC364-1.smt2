...
(assert (! (and (= tm_encryption tm_encryption) (= tm_access_control_method tm_encryption) (or (= tm_encryption tm_encryption) (= tm_access_control_method tm_encryption))) :named w_kgc364))
(check-sat)
(get-unsat-core)
(get-model)
(exit)
